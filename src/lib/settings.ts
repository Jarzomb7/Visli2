...
export const SETTINGS_SCHEMA = [
  ...
  { group: "general", key: "APP_NAME", label: "Application Name", placeholder: "VISLI" },
  { group: "general", key: "APP_URL", label: "Application URL", placeholder: "https://..." },
  { group: "general", key: "API_URL", label: "API URL", placeholder: "https://..." },
  { group: "general", key: "SUPPORT_EMAIL", label: "Support Email", placeholder: "support@..." },
  { group: "analytics", key: "GA_MEASUREMENT_ID", label: "Google Analytics ID", placeholder: "G-XXXXXXXXXX" },
