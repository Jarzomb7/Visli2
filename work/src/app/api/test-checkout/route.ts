 ...
 * Redirects to Stripe Checkout using DB-configured price IDs.
 */
      ...
      return NextResponse.json(
        {
          ...
          hint: "Go to Settings → Stripe and set the price ID for this product/plan combination.",
          expectedKey: `STRIPE_PRICE_${productCode}_${plan}`.toUpperCase(),
        },
        { status: 400 }
      );
    }
