    ...
    <div className="animate-fade-in">
      ...
      <div className="glass-card mb-6">
        <div className="border-b border-white/[0.05] px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/client/subscriptions" className="text-xs text-emerald-400 hover:underline">View all</Link>
        </div>
      ...
      <div className="glass-card">
        <div className="border-b border-white/[0.05] px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/client/licenses" className="text-xs text-emerald-400 hover:underline">Manage</Link>
        </div>
        <div className="divide-y divide-white/[0.03]">
          {licenses.length === 0 ? (
